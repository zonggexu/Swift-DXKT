 ...
 */
/// 获取好友列表GET
func getFetchAllAddressBookList() {
    ...
    do {
        ...
        ControllerManager.SharedInstance.mainDataArray = allFriendsListArray
    } catch {
        print(error)
    }
...
func fetchAllAddressBookList(callback: ([BookListModel]) -> Void) {
    callback( ControllerManager.SharedInstance.mainDataArray)
}
/// 根据手机号获取用户信息
