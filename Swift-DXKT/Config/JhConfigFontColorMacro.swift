...
func UIColorFromRGB(_ rgbValue: String) -> UIColor? {
    return UIColor.Jh_hexColorA(rgbValue, 1.0)
    
}
/// 十六进制颜色设置(带透明度)
func UIColorFromRGBAndAlpha(_ rgbValue: String,_ a:CGFloat) -> UIColor? {
    return UIColor.Jh_hexColorA(rgbValue, a)
}
